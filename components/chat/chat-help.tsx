...
import { IconHeadset, IconMail, IconQuestionMark } from "@tabler/icons-react";
...
export const ChatHelp: FC<ChatHelpProps> = ({}) => {
  ...
  useHotkey(t("/"), () => setIsOpen(prevState => !prevState));
    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DropdownMenuContent align="end">
        <DropdownMenuLabel className="flex items-center justify-between">
          <div className="flex space-x-2">{t("Gosign Support")}</div>
          ...
          <div className="flex space-x-2">
            ...
            <Link
              ...
              href={
                ...
                "https://github.com/gosign-de/very-ai/issues"
              }
              target="_blank"
