...
export const ChatSettingsForm: FC<ChatSettingsFormProps> = ({
  ...
  const { profile, models: _models } = useContext(ChatbotUIContext);
    ...
    <div className="space-y-3">
      <div className="space-y-1">
        ...
        <ModelSelect
          ...
          onSelectModel={model => {
            const newContextLength = getDefaultContextLength(model);
            onChangeChatSettings({
              ...chatSettings,
              model,
      ...
      <div className="space-y-1">
        ...
        <ModelSelect
          ...
          onSelectModel={imageModel => {
            onChangeChatSettings({ ...chatSettings, imageModel });
          }}
          imageModels={true}
        />
      </div>
