...
describe("extractOpenapiData for body 2", () => {
  it("should parse a valid OpenAPI body schema for body 2", async () => {
    ...
    expect(params0).toHaveProperty("stocksTicker");
    expect(params0.stocksTicker.type).toBe("string");
    expect(params0).toHaveProperty("date");
    expect(params0.date.type).toBe("string");
    expect(params0.date).toHaveProperty("format", "date");
    ...
    expect(params1).toHaveProperty("stocksTicker");
    expect(params1.stocksTicker.type).toBe("string");
  });
});
