...
function addApiKeysToProfile(profile: Tables<"profiles">) {
  const apiKeys = {
    ...
    [VALID_ENV_KEYS.DALLE_API_KEY]: "dalle_api_key",
    [VALID_ENV_KEYS.FLUX1_API_KEY]: "flux1_api_key",
    [VALID_ENV_KEYS.DEEPSEEK_API_SERVICE_ACCOUNT]:
      "deepseek_api_service_account",
    ...
    [VALID_ENV_KEYS.AZURE_GPT_5_NAME]: "azure_openai_gpt5_id",
