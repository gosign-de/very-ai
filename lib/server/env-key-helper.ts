...
// Helper function to get environment key map on server side
// This is the same logic as /api/keys/route.ts but callable directly
export function getEnvKeyMap() {
